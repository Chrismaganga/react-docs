    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mb-6">
          Learn how to manage component state using the useState hook. State allows components
          to remember and update information over time.
        </p>
      </div>
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        ...
        <ul className="text-sm text-gray-700 space-y-1">
          <li>• useState returns an array with the current state and a setter function</li>
